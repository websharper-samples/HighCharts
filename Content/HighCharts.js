...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,jQuery,Site,Samples,WebSharper,List,ChartControl,Set,MapControl,StockControl,Html,Client,Default,T,Client1,Arrays,Builder,Operators,Sample,document,Operators1,Unchecked,EventsPervasives,Seq;
 Runtime.Define(Global,{
  Site:{
   ChartControl:{
    Main:function(el)
   ...
   Client:{
    ...
    {
     StockControl.Main(Default.Div(Runtime.New(T,{
      $:0
     })).Dom);
   ...
   StockControl:{
    Main:function(el)
    {
     jQuery.getJSON("http://www.highcharts.com/samples/data/jsonp.php?filename=aapl-c.json&callback=?",Runtime.Tupled(function(tupledArg)
     {
      var data,returnVal,returnVal1;
      data=tupledArg[0];
      returnVal={};
