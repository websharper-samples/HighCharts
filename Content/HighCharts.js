...
{
 "use strict";
 var Global,Site,Client,Samples,Set,Sample,WebSharper,Operators,Obj,UI,HtmlModule,attr,List,Doc,SC$1,T,EventTarget,Node,JavaScript,JS,Unchecked,AttrProxy,Pervasives,AttrModule,Array,Client$1,Templates,MapControl,ChartControl,StockControl,WindowOrWorkerGlobalScope,Attrs,DomUtility,View,Arrays,Object,Collections,Dictionary,Seq,SC$2,SC$3,SC$4,Snap,DocElemNode,CharacterData,Enumerator,SC$5,HashSet,SC$6,Builder,T$1,Elt,Attrs$1,Dyn,DictionaryUtil,Prepare,Slice,KeyCollection,Docs,An,Settings,Abbrev,Mailbox,Updates,Strings,Docs$1,RunState,NodeSet,Anims,SC$7,Fresh,SC$8,HashSetUtil,SC$9,Concurrency,AppendList,Queue,Easing,AsyncBody,SC$10,CT,HashSet$1,SC$11,Scheduler,CancellationTokenSource,DomNodes,Error,OperationCanceledException,Lazy,SC$12,LazyExtensionsProxy,LazyRecord,IntelliFactory,Runtime,console,$,Date;
 Global=self;
 ...
 Doc=UI.Doc=UI.Doc||{};
 SC$1=Global.StartupCode$HighCharts$Client=Global.StartupCode$HighCharts$Client||{};
 T=List.T=List.T||{};
 ...
 MapControl=Site.MapControl=Site.MapControl||{};
 ChartControl=Site.ChartControl=Site.ChartControl||{};
 StockControl=Site.StockControl=Site.StockControl||{};
 ...
 SC$2=Global.StartupCode$HighCharts$Highmap=Global.StartupCode$HighCharts$Highmap||{};
 SC$3=Global.StartupCode$HighCharts$Highchart=Global.StartupCode$HighCharts$Highchart||{};
 SC$4=Global.StartupCode$HighCharts$Highstock=Global.StartupCode$HighCharts$Highstock||{};
 ...
 Sample=Samples.Sample=Runtime.Class({
  Show:function()
  {
   ...
   })],[]),Doc.Element("a",[AttrProxy.Create("class","btn btn-primary btn-lg"),AttrProxy.Create("href","http://github.com/intellifactory/websharper.highcharts/blob/master/Site/"+this.FileName)],[Doc.TextNode("Source")])]);
   Templates.LoadLocalTemplates("");
   Doc.RunAppend(sSide,a);
  }
 },null,Sample);
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.All=Set.Create([Set.Singleton(MapControl.Sample()),Set.Singleton(ChartControl.Sample()),Set.Singleton(StockControl.Sample())]);
 };
 ...
 MapControl.Sample=function()
 {
  SC$2.$cctor();
  return SC$2.Sample;
 };
 MapControl.Main=function(el)
 {
  var r,r$1,r$2,r$3,r$4,r$5,r$6,r$7,r$8,r$9,r$10,r$11;
  $(el).highcharts("Map",(r={},r.chart=(r$1={},r$1.spacingBottom=20,r$1),r.title=(r$2={},r$2.text="Europe time zones",r$2),r.legend=(r$3={},r$3.enabled=true,r$3),r.plotOptions=(r$4={},r$4.map=(r$5={},r$5.allAreas=false,r$5.joinBy=["iso-a2","code"],r$5.dataLabels=(r$6={},r$6.enabled=true,r$6.color="white",r$6.formatter=function()
  {
   var a;
   a=this.point.properties;
   return a?5>a.labelrank?a["iso-a2"]:null:null;
  },r$6.format=null,r$6.style={
   fontWeight:"bold"
  },r$6),r$5.tooltip=(r$7={},r$7.headerFormat="",r$7.pointFormat="{point.name}: <b>{series.name}</b>",r$7),r$5),r$4),r.series=[(r$8={},r$8.name="UTC",r$8.mapData=MapControl.map(),r$8.data=Arrays.map(function(e)
  {
   return{
    code:e
   };
  },["IE","IS","GB","PT"]),r$8),(r$9={},r$9.name="UTC +1",r$9.mapData=MapControl.map(),r$9.data=Arrays.map(function(e)
  {
   return{
    code:e
   };
  },["NO","SE","DK","DE","NL","BE","LU","ES","FR","PL","CZ","AT","CH","LI","SK","HU","SI","IT","SM","HR","BA","YF","ME","AL","MK"]),r$9),(r$10={},r$10.name="UTC +2",r$10.mapData=MapControl.map(),r$10.data=Arrays.map(function(e)
  {
   return{
    code:e
   };
  },["FI","EE","LV","LT","BY","UA","MD","RO","BG","GR","TR","CY"]),r$10),(r$11={},r$11.name="UTC +3",r$11.mapData=MapControl.map(),r$11.data=Arrays.map(function(e)
  {
   return{
    code:e
   };
 ...
 MapControl.map=function()
 {
  SC$2.$cctor();
  return SC$2.map;
 };
 ChartControl.Sample=function()
 {
  SC$3.$cctor();
  return SC$3.Sample;
 };
 ChartControl.Main=function(el)
 {
  var r,r$1,r$2,r$3,r$4,r$5,r$6,r$7,r$8,r$9,r$10,r$11,r$12;
  $(el).highcharts((r={},r.title=(r$1={},r$1.text="Monthly Average Temperature",r$1.x=-20,r$1),r.subtitle=(r$2={},r$2.text="Source: WorldClimate.com",r$2.x=-20,r$2),r.xAxis=[(r$3={},r$3.categories=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],r$3)],r.yAxis=[(r$4={},r$4.title=(r$5={},r$5.text="Temperature (°C)",r$5),r$4.plotLines=[(r$6={},r$6.value=0,r$6.width=1,r$6.color="#808080",r$6)],r$4)],r.tooltip=(r$7={},r$7.valueSuffix="°C",r$7),r.legend=(r$8={},r$8.layout="vertical",r$8.align="right",r$8.verticalAlign="middle",r$8.borderWidth=0,r$8),r.series=[(r$9={},r$9.name="Tokyo",r$9.data=[7,6.9,9.5,14.5,18.2,21.5,25.2,26.5,23.3,18.3,13.9,9.6],r$9),(r$10={},r$10.name="New York",r$10.data=[-0.2,0.8,5.7,11.3,17,22,24.8,24.1,20.1,14.1,8.6,2.5],r$10),(r$11={},r$11.name="Berlin",r$11.data=[-0.9,0.6,3.5,8.4,13.5,17,18.6,17.9,14.3,9,3.9,1],r$11),(r$12={},r$12.name="London",r$12.data=[3.9,4.2,5.7,8.5,11.9,15.2,17,16.6,14.2,10.3,6.6,4.8],r$12)],r));
 };
 StockControl.Sample=function()
 {
  SC$4.$cctor();
  return SC$4.Sample;
 };
 StockControl.Main=function(el)
 {
  $.getJSON("http://www.highcharts.com/samples/data/jsonp.php?filename=aapl-c.json&callback=?",function($1)
  {
   var r,r$1,r$2,r$3;
   $(el).highcharts("StockChart",(r={},r.title=(r$1={},r$1.text="AAPL stock price",r$1),r.rangeSelector=(r$2={},r$2.selected=1,r$2.inputEnabled=$(el).width()>480,r$2),r.series=[(r$3={},r$3.name="AAPL",r$3.data=$1,r$3)],r));
  });
 };
 ...
 SC$2.$cctor=function()
 {
  ...
  SC$2.map=self.Highcharts.maps["custom/europe"];
  SC$2.Sample=Samples.Build().Id("Highmaps").FileName("Highmap.fs").Keywords(List.ofArray(["highmaps","charts"])).Render(function(e)
  {
   MapControl.Main(e);
  }).Create();
 };
 SC$3.$cctor=function()
 {
  ...
  SC$3.Sample=Samples.Build().Id("Highcharts").FileName("Highchart.fs").Keywords(List.ofArray(["highcharts","charts"])).Render(function(e)
  {
   ChartControl.Main(e);
  }).Create();
 };
 SC$4.$cctor=function()
 {
  ...
  SC$4.Sample=Samples.Build().Id("Highstock").FileName("Highstock.fs").Keywords(List.ofArray(["highstock","charts"])).Render(function(e)
  {
   StockControl.Main(e);
  }).Create();
 };
